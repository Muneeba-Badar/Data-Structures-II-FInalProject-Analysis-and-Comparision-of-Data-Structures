...
void FindByWord(const string &filename, const string &output_path, const string &key) {
...
void InsertNewWord(const string &filename, const string &word) {
    ...
    // Insert the new word, meaning, and part of speech into BST
    fe->InsertWord(word);
...
//search
    ...
    //         FindByWord(inputFileName, "./output/output_BST_find_by_word.txt",wordList[i]);
    //         auto stop = steady_clock::now();
    //         auto duration = duration_cast<microseconds>(stop-start);
    //         // cout << "Time taken by BST Find by Word: "
